package com.shapes; // TODO: Change to your package name
...
public class World {
    ...
    public World(double width, double height) {
        ...
        shapes[1] = new Circle(50, Color.BLUE);
        shapes[1].setVelocity(10, 20);
        shapes[2] = new Rectangle(75,90, Color.GREEN);
